...
const useNavigation = () => {
    ...
    // useEffect(() => {
    //     if (
    //         store.state.form.CLNT &&
    //         hospital !== store.state.form.CLNT.toLowerCase()
    //     ) {
    ...
    //         })
    //     }
    //     const requestOption = store.state.form.FTYPE

    //     // console.log('Request:', requestHospital, requestOption)
    //     // console.log('Current:', hospital, option)
    // }, [hospital])
