...
const hospitals = {
    ...
    benioff: {
        ...
        slug: 'BENIOFF',
        name: "",
        logo: '/images/HIDEbenioff-logo.png',
        isWhitelabel: true,
        processingTime: '14 business days',
        facilities: [
            {
                id: 'P7105-1',
                name: "Info No Longer Available",
                address: ['', ''],
                phone: '',
            },
        ],
        ...
        facilities: [
            {
                ...
                phone: '(205) 319-2100',
                fax: '(702) 462-9932',
                email: 'recordrequest@libertyhospital.org',
            },
        ],
    },
    ...
    Sensenbrenner: {
        status: 'launched',
        slug: 'Sensenbrenner',
        name: 'Sensenbrenner Primary Care',
        logo: '/images/Sensenbrenner-logo.png',
        isWhitelabel: false,
        imageFee: '$0.00',
        altAuth: true,
    ...
    ucsf: {
        ...
        slug: 'UCSF',
        name: '',
        logo: '/images/HIDEucsf-merged-logo.jpg',
        isWhitelabel: true,
        processingTime: '14 business days',
        facilities: [
            {
    ...
    'ucsf-lpph': {
        ...
        slug: 'UCSF-LPPH',
        name: '',
        logo: '/images/HIDEucsf-lpph-logo.jpeg',
        isWhitelabel: true,
        processingTime: '14 business days',
        facilities: [
            {
