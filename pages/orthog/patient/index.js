                ...
                <Box className="w-full max-w-screen-md">
                    ...
                    <Box className="mt-8">
                        ...
                        <Box as="ul" className="pl-8 space-y-2 list-disc">
                            ...
                            <Box as="li">
                                Imaging (X-Rays, MRIs) CDs may be picked at The
                                Orthopedic Group Airport Boulevard Location or
                                mailed to you. Allow an average of 10 business
                                days for mail delivery time.
                            </Box>
                        </Box>
                    </Box>
