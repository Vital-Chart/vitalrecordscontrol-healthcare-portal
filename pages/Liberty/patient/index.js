                ...
                <Box className="w-full max-w-screen-md">
                    ...
                    <Box className="mt-8">
                        ...
                        <Box as="ul" className="pl-8 mb-6 space-y-2 list-disc">
                            <Box as="li">
                                This ordering site is for use by Liberty
                                Hospital{' '}
                            ...
                            <Box as="li">
                                Requested records are provided to patients 
                                at no charge.
                            </Box>
                            <Box as="li">
                            ...
                            <Box as="li">
                                You will be texted or emailed when the requested records
                                are ready to access online.
                            </Box>
                            <Box as="li">
                                Allow 5-7 business days for the processing of
                                your request.
                            </Box>
                            <Box as="li">
                                Radiology (imaging) records will be mailed.
                            </Box>
                        </Box>
                    </Box>
