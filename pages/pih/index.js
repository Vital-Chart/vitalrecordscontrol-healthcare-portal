            ...
            <Box className="w-full md:w-2/3 py-8 md:pr-12 md:pb-0 leading-relaxed">
                ...
                <Text className="pb-4">
                    * For Option 2, the designated Healthcare Provider must
                    ...
                    will do so, use Option 1 instead. We are not responsible for
                ...
                <Text className="pb-4">
                    ** The timeframe specified above for written records
                    ...
                    prepared by clinic staff and copied to a CD. Once the
                ...
                <Text className="pb-4">
                    *** For Option 2, you are solely responsible for the
                    ...
                    designated Healthcare Provider aware that a notice will be
                    faxed to them when the written records are ready and that
                    they must access those records online; and (c) following up,
                    if needed, with the Healthcare Provider to determine if they
                    have received a faxed notice and/or have accessed your
                    records.
                </Text>
            </Box>
