                ...
                <Box className="w-full max-w-screen-md">
                    ...
                    <Box as="ul" className="pl-8 mb-6 space-y-2 list-disc">
                        ...
                        <Box as="li">
                            ...
                            access online. You will receive no text alerts
                            regarding Imaging CDs.
                        </Box>
                        <Box as="li">
                            Imaging (X-Rays, MRIs) CDs may be picked up on the
                            5th floor of Carrell Clinic or mailed to you. Mail
                            delivery can add up to 14 days.
                        </Box>
                    </Box>
                    ...
                    <Box as="ul" className="pl-8 mb-6 space-y-2 list-disc">
                        ...
                        <Box as="li">
                            ...
                            access a minor child's records.
                        </Box>
                        <Box as="li">
