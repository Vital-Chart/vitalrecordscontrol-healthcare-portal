                ...
                >
                    ...
                    <FormSection className="border-b border-gray-light">
                        <Box as="fieldset">
                            ...
                            <CheckboxWrapper>
                                ...
                                >
                                    (i.e. ED provider notes, radiology reports,
                                    lab and diagnostic, consults and procedure
                                    notes)
                                </Checkbox>
                                <Checkbox
                                ...
                                >
                                    ...
                                    operative report, discharge summary, lab,
                                    radiology reports, nursing notes, progress
                                    notes)
                                </Checkbox>
                                <Checkbox
                            ...
                            {watchRequestedInformation.includes('OR') && (
                                <Box className="mt-4">
                                    ...
                                    {errors.RI_CB_OR && (
                                        <ErrorMessage
                                            className="mt-2"
                                            message={errors.RI_CB_OR.message}
                                        />
                                    )}
                                </Box>
                            )}
                    ...
                    <FormSection className="border-b border-gray-light">
                        ...
                        {watchRequestedInformation.length === 0 && (
                            <Text>
                                Delivery options will appear here once you've
                                selected the records you'd like to receive.
                            </Text>
                        )}
                        ...
                        {watchRequestedInformation.some(i =>
                            ...
                            <Box className="p-8 mb-6 bg-gray-lightest">
                                ...
                                <Text className="mb-4">
                                    ...
                                    the website, or have them created on CD to
                                    be delivered by mail via the US Postal
                                    Service to the address entered above, or
                        ...
                        {watchRequestedInformation.includes('RI') && (
                            <Box className="p-8 mb-6 bg-gray-lightest">
                                ...
                                <Text className="mb-4">
                                    Radiology Images are automatically saved to
                                    CD. They can be delivered by mail via the US
                                    Postal Service to the address entered above,
                                    or Picked up at the Medical Facility. The
                                    department will contact you if additional
                                ...
                                <Box className="mb-4">
                                    ...
                                    {errors.DI_DMRP_OPT && (
                                        <ErrorMessage
                                            className="mt-2"
                                            message={errors.DI_DMRP_OPT.message}
                                        />
                                    )}
                                </Box>
                            </Box>
