            ...
            <Container>
                <Box className="w-full max-w-screen-md">
                    ...
                    <Box as="ul" className="pl-8 mb-6 space-y-2 list-disc">
                        ...
                        <Box as="li">
                            All written records (including imaging reports) are
                            provided to patients for a flat fee of $15 per
                            request.
                        </Box>
                        <Box as="li">
                            ALL available medical records are provided. You do
                            not need to specify the types of written records or
                            dates of service.
                        </Box>
                        <Box as="li">
                            Written records (excludes X-Ray and MRI imaging) are
                        ...
                        <Box as="li">
                            If you need a CD of Images (MRI or X-rays), please
                            put in a separate request for the CD through your
                            portal account at{' '}
                            <Link
                        ...
                        <Box as="li">
                            You will be texted when written records are ready to
                            access online.
                        </Box>
                    </Box>
                    ...
                    <Box as="ul" className="pl-8 mb-6 space-y-2 list-disc">
                        <Box as="li">
                            Patients who have reached the age of majority: 18
                        ...
                        <Box as="li">
                            Parents/guardians who have the legal authority to
                            access a{' '}
                            <Text as="span" className="italic">
                                minor
                            </Text>{' '}
                    ...
                    <Box as="ol" className="pl-8 pb-2 space-y-2 list-decimal">
                        ...
                        <Box as="li">
                            ...
                            AND (b){' '}
                            <Text as="span" className="font-bold">
                                official documentation of your authority to make
